const defaultProducts = [
  ...
  { id: 5, name: "CupEat Milktea", price: 85, category: "Beverage", stock: 50, image: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&q=80&w=600" },
  { id: 6, name: "Grilled Platter", price: 450, category: "Main Course", stock: 30, image: "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80&w=600" },
  { id: 7, name: "Bucket Deal (Beer)", price: 350, category: "Beverage", stock: 20, image: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&q=80&w=600" },
  { id: 8, name: "Fresh Garden Salad", price: 120, category: "Appetizer", stock: 40, image: "https://images.unsplash.com/photo-1606787366850-de6330128bfc?auto=format&fit=crop&q=80&w=600" }
];
